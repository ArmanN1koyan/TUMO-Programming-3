...
class GrassEater extends LivingCreature {
    ...
    eat() {
        ...
        for (var i = 0; i <= 4; i++) {
            var randgrass = Math.round(random(2));
        }

        var newCell = random(this.chooseCell(randgrass));
...
class BlueGrass extends LivingCreature {
    ...
    mul() {
        ...
        if (this.multiply >= 16 && newCell) {
            var newBlueGrass = new BlueGrass(newCell[0], newCell[1], this.index);
...
class AllEater extends LivingCreature {
    ...
    eat() {
        ...
        for (var i = 0; i <= 4; i++) {
            var randcube = Math.round(random(4));
        }

        var newCell = random(this.chooseCell(randcube));
...
class Light extends LivingCreature {
    ...
    mul() {
        ...
        for (var i = 0; i <= 4; i++) {
            var rand = Math.round(random(4));
            var randpleace = Math.round(random(5));
        }

        this.multiply++;
        var newCell = random(this.chooseCell(randpleace));
        if (this.multiply >= 50 && newCell) {
            var newLight = new Light(newCell[0], newCell[1], this.index);
